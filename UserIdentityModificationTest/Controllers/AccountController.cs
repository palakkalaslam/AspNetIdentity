...
using UserIdentityModificationTest.Models;
using SendGrid;
using System.Net;
...
namespace UserIdentityModificationTest.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        /// <summary>
        /// the code used for resend the confirmation message to the user 
        /// </summary>
